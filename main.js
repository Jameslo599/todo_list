...
const makeProjectList = () => {
    ...
    let approvedProject = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'input', id: `approvedProject`, 
    className: 'approvedProject', href: '#'});
    approvedProject.type = 'submit';

    let rejectedProject = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'input', id: 'rejectedProject', 
