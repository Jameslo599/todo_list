...
/* harmony export */   "makeTodayPile": () => (/* binding */ makeTodayPile),
/* harmony export */   "makeTitle": () => (/* binding */ makeTitle),
/* harmony export */   "makeToday": () => (/* binding */ makeToday)
/* harmony export */ });
/* harmony import */ var _make_items_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./make-items.js */ "./src/make-items.js");
...
const makeTitle = () => {
    let title = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'h2', id: 'title', 
    className: 'title'});
    title.innerHTML = 'Inbox'
    title.style.display = 'block'
    _sidebar_js__WEBPACK_IMPORTED_MODULE_1__.grid.prepend(title);
};
const makeToday = () => {
    let today = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'h2', id: 'today', 
    className: 'title'});
    today.innerHTML = 'Today'
    _sidebar_js__WEBPACK_IMPORTED_MODULE_1__.grid.prepend(today);
}
const makePile = () => {
    let taskPile = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'div', id: 'pile', 
    className: 'pile'});
    title.appendChild(taskPile);

    let taskList = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'ul', id: 'list', 
    className: 'list'});
    taskPile.appendChild(taskList);
    
    let task = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'li', id: 'task', 
    className: 'task'});
    ...
    let taskIcon = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'i', id: 'taskIcon', 
    className: 'fal fa-plus-circle'});
    taskLink.appendChild(taskIcon);
};
const makeTodayPile = () => {
    let taskPile = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'div', id: 'todayPile', 
    className: 'pile'});
    today.appendChild(taskPile);

    let taskList = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'ul', id: 'todayList', 
    className: 'list'});
    taskPile.appendChild(taskList);
    
    let task = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'li', id: 'todayTask', 
    className: 'task'});
    task.innerHTML = 'Add Task ';
    taskList.appendChild(task);
    ...
    let taskIcon = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'i', id: 'todayIcon', 
    className: 'fal fa-plus-circle'});
    taskLink.appendChild(taskIcon);
};
...
(0,_todo_pile_js__WEBPACK_IMPORTED_MODULE_2__.makeToday)();
(0,_todo_pile_js__WEBPACK_IMPORTED_MODULE_2__.makePile)();
(0,_todo_pile_js__WEBPACK_IMPORTED_MODULE_2__.makeTodayPile)();
(0,_sidebar_js__WEBPACK_IMPORTED_MODULE_3__.makeSidebar)();
(0,_sidebar_js__WEBPACK_IMPORTED_MODULE_3__.showAllProjects)();
