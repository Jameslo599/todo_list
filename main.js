...
const addTask = () => {
    ...
    for (let i = 0; i <= 1; i++) {
        let chooseProject = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'option', id: `project${i}`});
    ...
    let cancel = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'button', id: 'cancel', 
    className: 'button'});
