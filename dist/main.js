...
var makeElement = function makeElement() {
  ...
  var toggleList = function toggleList(button, list) {
    document.getElementById("".concat(button)).addEventListener("click", function () {
      if (document.getElementById("".concat(list)).style.display === "none") {
        document.querySelectorAll("h2[class^=\"lists\"]").forEach(function (element) {
          element.style.display = "none";
        });
        document.getElementById("".concat(list)).style.display = "block";
...
var addProject = function addProject() {
  ...
  document.getElementById("projectForm").addEventListener("submit", function (event) {
    ...
    var _loop = function _loop(i) {
      ...
      document.getElementById("customList".concat(i)).style.display = "none";
