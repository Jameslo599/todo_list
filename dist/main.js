...
const makeSidebar = () => {
    ...
    for (let i = 0; i <= 2; i++) {
    let sideItem = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'a', id: `project${i}`, 
