...
let makeNavbar = () => {
    let navBar = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'ul', id: 'navbar', 
    className: 'navbar'});
    content.appendChild(navBar);

    let hamburgerLink = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'a', href: '#'});
    ...
    let hamburger = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'i', id: 'hamburger', 
    className: 'fal fa-bars'});
    hamburgerLink.appendChild(hamburger);

    let navLogo = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'i', id: 'navLogo', 
    className: 'far fa-check-square'});
    navBar.appendChild(navLogo);

    let navItems = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'li', id: 'nav', 
    className: 'nav'});
    navItems.innerHTML = 'To-Do List'
    navBar.appendChild(navItems);

    let taskLink = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'a', href: '#'});
    navBar.appendChild(taskLink);

    let addTask = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'i', id: 'navTask', 
...
const addTask = () => {
    let modalContainer = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'modalContainer', 
    className: 'modalContainer'});
    content.appendChild(modalContainer);

    let newTask = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'form', id: 'newTask', 
    className: 'newTask'});
    modalContainer.appendChild(newTask);

    let header = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'h2', id: 'modalHeader', 
    className: 'modalHeader'});
    header.innerHTML = 'New Task'
    newTask.appendChild(header);

    let closeLink = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'a', href: '#'});
    header.appendChild(closeLink);

    let closeIcon = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'i', id: 'closeIcon', 
    className: 'fas fa-times'});
    closeLink.appendChild(closeIcon);

    let body = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'modalBody', 
    className: 'modalBody'});
    newTask.appendChild(body);

    let title = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'modalTitle', 
    className: 'left-side'});
    title.innerHTML = `Title:<br>`
    body.appendChild(title);

    let titleInput = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'input', id: 'titleInput', 
    className: 'input'});
    titleInput.type = 'text'
    titleInput.required = true;
    title.appendChild(titleInput);

    let date = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'date', 
    className: 'right-side'});
    date.innerHTML = `Due Date:<br>`
    body.appendChild(date);

    let dateInput = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'input', id: 'dateInput', 
    className: 'input'});
    dateInput.type = 'datetime-local'
    dateInput.min = `${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(new Date(), 'yyyy-MM-dd\'T\'HH:mm')}`;
    dateInput.required = true;
    date.appendChild(dateInput);

    let description = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'description', 
    className: 'left-side'});
    description.innerHTML = `Description:<br>`
    body.appendChild(description);

    let descriptionInput = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'textarea', id: 'descriptionInput', 
    className: 'input'});
    ...
    let priority = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'priority', 
    className: 'right-side'});
    priority.innerHTML = `Priority:<br>`
    body.appendChild(priority);

    let priorityInput = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'select', id: 'priorityInput', 
    className: 'input'});
    priority.appendChild(priorityInput);

    for (let i = 0; i <= 3; i++) {
        let choosePriority = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'option', id: `priority${i}`});
    ...
    let project = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'project', 
    className: 'right-side'});
    project.innerHTML = `Project:<br>`
    priority.appendChild(project);

    let projectInput = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'select', id: 'projectInput', 
    className: 'input'});
    project.appendChild(projectInput);

    for (let i = 0; i <= 1; i++) {
        let chooseProject = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'option', id: `projectChoice${i}`});
    ...
    let buttonHolderLeft = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'buttonHolder', 
    className: 'left-side'});
    body.appendChild(buttonHolderLeft);

    let buttonHolderRight = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'buttonHolder', 
    className: 'right-side'});
    body.appendChild(buttonHolderRight);

    let cancel = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'input', id: 'cancel', 
    className: 'button'});
    cancel.type = 'reset'
    buttonHolderRight.appendChild(cancel);

    let submission = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'input', id: 'submission', 
    className: 'button'});
...
const editTask = () => {
    let newTaskClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'form', id: 'newTaskClone', 
    className: 'newTask'});
    newTaskClone.style.display = 'none';
    modalContainer.appendChild(newTaskClone);

    let headerClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'h2', id: 'modalHeaderClone', 
    className: 'modalHeader'});
    headerClone.innerHTML = 'New Task'
    newTaskClone.appendChild(headerClone);

    let closeLinkClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'a', href: '#'});
    headerClone.appendChild(closeLinkClone);

    let closeIconClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'i', id: 'closeIcon', 
    className: 'fas fa-times'});
    closeLinkClone.appendChild(closeIconClone);

    let bodyClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'modalBodyClone', 
    className: 'modalBody'});
    newTaskClone.appendChild(bodyClone);

    let titleClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'modalTitleClone', 
    className: 'left-side'});
    titleClone.innerHTML = `Title:<br>`
    bodyClone.appendChild(titleClone);

    let titleInputClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'input', id: 'titleInputClone', 
    className: 'input'});
    titleInputClone.type = 'text'
    titleInputClone.required = true;
    titleClone.appendChild(titleInputClone);

    let dateClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'dateClone', 
    className: 'right-side'});
    dateClone.innerHTML = `Due Date:<br>`
    bodyClone.appendChild(dateClone);

    let dateInputClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'input', id: 'dateInputClone', 
    className: 'input'});
    dateInputClone.type = 'datetime-local'
    dateInputClone.min = `${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(new Date(), 'yyyy-MM-dd\'T\'HH:mm')}`;
    dateInputClone.required = true;
    dateClone.appendChild(dateInputClone);

    let descriptionClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'descriptionClone', 
    className: 'left-side'});
    descriptionClone.innerHTML = `Description:<br>`
    bodyClone.appendChild(descriptionClone);

    let descriptionInputClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'textarea', id: 'descriptionInputClone', 
    className: 'input'});
    ...
    let priorityClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'priorityClone', 
    className: 'right-side'});
    priorityClone.innerHTML = `Priority:<br>`
    bodyClone.appendChild(priorityClone);

    let priorityInputClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'select', id: 'priorityInputClone', 
    className: 'input'});
    priorityClone.appendChild(priorityInputClone);

    for (let i = 0; i <= 3; i++) {
        let choosePriority = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'option', id: `priorityClone${i}`});
    ...
    let projectClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'projectClone', 
    className: 'right-side'});
    projectClone.innerHTML = `Project:<br>`
    priorityClone.appendChild(projectClone);

    let projectInputClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'select', id: 'projectInputClone', 
    className: 'input'});
    projectClone.appendChild(projectInputClone);

    for (let i = 0; i <= 1; i++) {
        let chooseProject = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'option', id: `projectChoiceClone${i}`});
    ...
    let buttonHolderLeftClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'buttonHolderClone', 
    className: 'left-side'});
    bodyClone.appendChild(buttonHolderLeftClone);

    let buttonHolderRightClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'div', id: 'buttonHolderClone', 
    className: 'right-side'});
    bodyClone.appendChild(buttonHolderRightClone);

    let cancelClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'input', id: 'cancelClone', 
    className: 'button'});
    cancelClone.type = 'reset'
    buttonHolderRightClone.appendChild(cancelClone);

    let submissionClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'input', id: 'submissionClone', 
    className: 'button'});
...
const makeSidebar = () => {
    let sidebar = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'div', id: 'sidenav', 
    className: 'sidenav'});
    grid.appendChild(sidebar);

    for (let i = 0; i <= 2; i++) {
    let sideItem = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'button', id: `project${i}`, 
    className: 'project', href: '#'});
    sidebar.appendChild(sideItem);
    };
    document.getElementById('project0').innerHTML = 'Inbox';
        let inboxIcon = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'i', id: 'homeIcon', 
        className: 'fad fa-inbox'});
        document.getElementById('project0').prepend(inboxIcon);

    document.getElementById('project1').innerHTML = 'Today';
        let todayIcon = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'i', id: 'calendarIcon', 
        className: 'fas fa-calendar-day'});
        document.getElementById('project1').prepend(todayIcon);

    document.getElementById('project2').innerHTML = 'Projects';
        let diagramIcon = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'i', id: 'listIcon', 
        className: 'fas fa-list'});
        document.getElementById('project2').prepend(diagramIcon);

    let projectList = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'div', id: `projectList`, 
    className: 'project', href: '#'});
    let inputForm = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'form', id: `projectForm`,});
...
const makeProjectList = () => {
    let inputBar = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'input', id: `inputBar`, 
    className: 'inputBar', href: '#'});
    inputBar.type = 'text';
    inputBar.required = true;
    inputBar.placeholder = 'Add Project';

    let approvedProject = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'button', id: `approvedProject`, 
    className: 'fas fa-check-square', href: '#'});  
    approvedProject.type = 'submit';

    let rejectedProject = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'button', id: 'rejectedProject', 
...
const addProject = () => {
    ...
    document.getElementById('projectForm').addEventListener('submit', (event) => {
        ...
        for (let i = (projectArray.length - 1); i < projectArray.length; i++ ) {
            let project = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'button', id: `customButton${i}`, 
            className: 'project', href: '#'});
            project.innerHTML = `${projectArray[i]}`

            let icon = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'i', id: 'icon', 
            className: 'fas fa-circle'});
            project.prepend(icon);
            document.getElementById('projectList').appendChild(project);

            (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeList)({id: `customProject${i}`, text: `${textValue}`});
...
/* harmony export */   "makeTaskButton": () => (/* binding */ makeTaskButton),
...
let loadTasks = () => {
    document.getElementById('newTask').addEventListener('submit', function sendInfo(event) {
        event.preventDefault();
        let submission = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeTask)({
...
function makeTrash(newTask) {
    let trash = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'a', id: 'trashIcon', className: 'far fa-trash-alt'});
...
function editInfo(newTask, i, localTime) {
    let edit = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'i', id: 'editIcon', 
...
function changeInfo(event) {
    event.preventDefault();
    let submissionEdit = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeTask)({
        title: `${document.getElementById("titleInputClone").value}`,
        description: `${document.getElementById("descriptionInputClone").value}`,
        priority: `${document.getElementById("priorityInputClone").value}`,
    });
    ...
    document.getElementById(`title${i}`).innerHTML = `Title: ${myTasks[i].title}`;
    document.getElementById(`description${i}`).innerHTML = `Description: ${myTasks[i].description}`;
    document.getElementById(`taskDate${i}`).innerHTML = `Date: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(new Date(document.getElementById("dateInputClone").value), 'PPpp')}`;
    document.getElementById(`taskPriority${i}`).innerHTML = `Priority: ${myTasks[i].priority}`;
    modalContainer.style.display = 'none';
    document.getElementById('submission').value = 'Add Task';
...
function makeTaskButton() {
    document.getElementById('newTask').addEventListener('submit', function logInfo(event) {
        ...
        let newTask = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'button', id: `createdTask${i}`, 
        ...
        let title = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'p', id: `title${i}`,
        className: 'property'});
        title.innerHTML = `Title: ${myTasks[i].title}`;

        let description = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'p', id: `description${i}`,
        className: 'property'});
        description.innerHTML = `Description: ${myTasks[i].description}`;

        let taskDate = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'p', id: `taskDate${i}`,
        className: 'property'});
        taskDate.innerHTML = `Date: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(new Date(localTime), 'PPpp')}`;

        let taskPriority = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'p', id: `taskPriority${i}`,
        className: 'property'});
        taskPriority.innerHTML = `Priority: ${myTasks[i].priority}`;

        let contentHolder = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({type: 'div', id: `createdHolder${i}`, 
...
(0,_make_items_js__WEBPACK_IMPORTED_MODULE_4__.makeList)({id: 'inbox', text: 'Inbox'});
document.getElementById('inbox').style.display = 'block';
document.getElementById('inboxList').style.display = 'block';
(0,_make_items_js__WEBPACK_IMPORTED_MODULE_4__.makeList)({id: 'today', text: 'Today'});
(0,_sidebar_js__WEBPACK_IMPORTED_MODULE_2__.makeSidebar)();
(0,_sidebar_js__WEBPACK_IMPORTED_MODULE_2__.showAllProjects)();
(0,_sidebar_js__WEBPACK_IMPORTED_MODULE_2__.makeProjectList)();
(0,_sidebar_js__WEBPACK_IMPORTED_MODULE_2__.addProject)();
(0,_modal_js__WEBPACK_IMPORTED_MODULE_3__.default)();
(0,_todo_items_js__WEBPACK_IMPORTED_MODULE_0__.loadTasks)();
(0,_todo_items_js__WEBPACK_IMPORTED_MODULE_0__.makeTaskButton)();
