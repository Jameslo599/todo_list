...
const editTask = (i) => {
    let newTaskClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'form', id: `newTaskClone${i}`, 
    className: 'newTask'});
    ...
    let titleInputClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'input', id: `titleInputClone${i}`, 
    className: 'input'});
    ...
    let dateInputClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'input', id: `dateInputClone${i}`, 
    className: 'input'});
    ...
    let descriptionInputClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'textarea', id: `descriptionInputClone${i}`, 
    className: 'input'});
    ...
    let priorityInputClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'select', id: `priorityInputClone${i}`, 
    className: 'input'});
    priorityClone.appendChild(priorityInputClone);

    for (let i = 0; i <= 3; i++) {
        let choosePriority = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'option', id: `priorityChoiceClone${i}`});
    ...
    let submissionClone = (0,_make_items_js__WEBPACK_IMPORTED_MODULE_0__.makeElement)({ type: 'input', id: `submissionClone${i}`, 
    className: 'button'});
...
function submitEdit(i) {
    (0,_modal_js__WEBPACK_IMPORTED_MODULE_1__.editTask)(i);
    document.getElementById(`newTaskClone${i}`).addEventListener('submit', function changeInfo(event) {
        ...
        document.getElementById(`taskDate${i}`).innerHTML = `Date: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(new Date(document.getElementById(`dateInputClone${i}`).value), 'PPpp')}`;
...
function makeTaskButton() {
    document.getElementById('newTask').addEventListener('submit', function logInfo(event) {
        ...
        className: 'property'});
        taskDate.innerHTML = `Date: ${(0,date_fns__WEBPACK_IMPORTED_MODULE_2__.default)(new Date(localTime), 'PPpp')}`;
...
(0,_modal_js__WEBPACK_IMPORTED_MODULE_3__.toggleModal)();
