...
var makeElement = function makeElement() {
  ...
  var makeList = function makeList() {
    ...
    listName.innerHTML = "".concat(text);
...
var loopElements = function loopElements() {
  ...
  var makeOptions = function makeOptions(length, inputId) {
...
var makeModal = function makeModal() {
  ...
  projectChoice.makeOptions(1, 'projectInput'); //  for (let i = 0; i <= 1; i++) {
...
var makeSidebar = function makeSidebar() {
  ...
  for (var i = 0; i <= 2; i++) {
    var sideItem = (0,_make_items__WEBPACK_IMPORTED_MODULE_0__.makeElement)({
      type: "button",
      id: "project".concat(i),
      className: "project",
      href: "#"
...
var showAllProjects = function showAllProjects() {
  var projectHolder = document.getElementById("project2");
...
var addProject = function addProject() {
  ...
  document.getElementById("projectForm").addEventListener("submit", function (event) {
    ...
    var _loop = function _loop(i) {
      ...
      makeProject.innerHTML = "".concat(textValue);
      ...
      project.innerHTML = "".concat(projectArray[i]);
      var icon = (0,_make_items__WEBPACK_IMPORTED_MODULE_0__.makeElement)({
        type: "i",
        id: "icon",
      ...
      makeList({
        id: "customProject".concat(i),
        text: "".concat(textValue)
      });
      var customProject = document.getElementById("customProject".concat(i));
      ...
      document.getElementById("customButton".concat(i)).addEventListener("click", function () {
        if (customProject.style.display = "none") {
          ...
          document.getElementById("customProject".concat(i, "List")).style.display = "block";
          document.getElementById("customProject".concat(i, "List")).setAttribute("name", "".concat(textValue + i));
        }
      });
    };

    for (var i = projectArray.length - 1; i < projectArray.length; i++) {
      _loop(i);
    }
  });
};
